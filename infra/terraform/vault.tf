...
resource "vault_jwt_auth_backend" "keycloak" {
  ...
  oidc_discovery_url = format("${var.keycloak_server}/auth/realms/%s" ,keycloak_realm.realm.id)
...
resource "vault_jwt_auth_backend_role" "default" {
  ...
  role_type             = "oidc"
  allowed_redirect_uris = ["${var.vault_server}/ui/vault/auth/oidc/oidc/callback", "${var.vault_server}/oidc/callback"]
